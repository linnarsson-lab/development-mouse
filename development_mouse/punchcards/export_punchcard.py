    ...
    def run(self) -> None:
        ...
        with self.output().temporary_path() as out_dir:
            ...
            try:
                ...
                dm.plot_abs_graph(ds, dsagg, os.path.join(out_dir, f"{self.card}_absgraph.aa.png"), tags)
            except:
                pass
            ...
            try:
                ...
                dm.plot_quality_graph(ds, dsagg, out_file=os.path.join(out_dir, f"{self.card}_quality_tsne.png"),
                ...
                plt.savefig(os.path.join(out_dir, self.card + "_quality_pie.png"))
            except:
                pass
            ...
            try:
                ...
                cg.plot_graph(ds, os.path.join(out_dir, f"{self.card}_UMAP_manifold.aaa.png"), tags, embedding="UMAP")
                logging.info("Plotting UMI and gene counts")
                cg.plot_umi_genes(ds, out_file=os.path.join(out_dir, self.card + "_umi_genes.png"))
                logging.info("Plotting factors")
                cg.plot_factors(ds, base_name=os.path.join(out_dir, self.card + "_factors"))
                logging.info("Plotting cell cycle")
                cg.plot_cellcycle(ds, out_file=os.path.join(out_dir, self.card + "_cellcycle.png"))
                logging.info("Plotting markers")
                cg.plot_markers(ds, out_file=os.path.join(out_dir, self.card + "_markers.png"))
                ...
                cg.plot_TFs(ds, dsagg, out_file_root=os.path.join(out_dir, self.card))
            except:
                pass
